...
*/
BookType::BookType(const std::string& title,
...
*/
void BookType::setTitle(const std::string& title)
{
bookTitle = title;
}
/**
...
*/
void BookType::setISBN(const std::string& isbn)
{
this->isbn = isbn;
}
/**
...
*/
void BookType::setAuthor(const std::string& author)
{
this->author = author;
}
/**
...
*/
void BookType::setWholesale(float wholesale)
{
...
*/
void BookType::setRetail(float retail)
{
this->retail = retail;
}
/**
...
*/
std::string BookType::getISBN() const
{
return isbn;
}
/**
...
*/
std::string BookType::getPub() const
{
return publisher;
}
/**
...
*/
std::string BookType::getDateAdded() const
{
return dateAdded;
}
/**
